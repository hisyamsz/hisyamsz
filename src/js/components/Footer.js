        ...
        <div class="container">
          <div class="flex flex-wrap">
            <div class="w-full px-4 mb-12 text-slate-300 md:w-1/3">
              <h3 class="mb-4 text-2xl font-bold text-white">About</h3>
              <p class="">hisyam.s901@gmail.com</p>
              <p>Kuta Baru</p>
              <p>Kec. Pasar Kemis</p>
            ...
            <div class="w-full px-4 mb-12 text-slate-300 md:w-1/3">
              <h3 class="mb-4 text-2xl font-bold text-white">Information</h3>
              <ul class="text-slate-300">
                <li><a href="#home" class="inline-block mb-3 text-base hover:text-primary">Home</a></li>
                <li><a href="#about" class="inline-block mb-3 text-base hover:text-primary">About me</a></li>
                <li><a href="#skills" class="inline-block mb-3 text-base hover:text-primary">Skills</a></li>
                <li><a href="#portfolio" class="inline-block mb-3 text-base hover:text-primary">Portfolio</a></li>
                <li><a href="#contact" class="inline-block mb-3 text-base hover:text-primary">Contact</a></li>
              </ul>
            </div>
          </div>
          <div class="w-full pt-10 border-t border-slate-800">
            <div class="flex items-center justify-center px-4 mb-8">
              <!-- Instagram -->
              <a href="https://instagram.com/hisyamsz_/" target="_blank" class="flex items-center justify-center border rounded-full w-9 h-9 border-slate-400 text-slate-400 hover:border-primary hover:bg-primary hover:text-white">
              ...
              <!-- Linkedln -->
              <a href="https://www.linkedin.com/in/hisyam-santoso-92a747279/" target="_blank" class="flex items-center justify-center mx-4 border rounded-full w-9 h-9 border-slate-400 text-slate-400 hover:border-primary hover:bg-primary hover:text-white">
              ...
              <!-- Github -->
              <a href="https://github.com/hisyamsz" target="_blank" class="flex items-center justify-center border rounded-full w-9 h-9 border-slate-400 text-slate-400 hover:border-primary hover:bg-primary hover:text-white">
            ...
            <p class="mb-2 text-sm font-medium text-center text-slate-300">
            ...
            <p class="text-sm font-medium text-center text-slate-300">&copy; 2026</p>
          </div>
        </div>
      </footer>
    `;
